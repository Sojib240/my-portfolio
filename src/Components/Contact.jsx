...
const Contact = () => {
    ...
    return (
        <section
            ref={contactMainRef}
            className="w-full min-h-[95vh] sm:min-h-screen h-full px-6 md:px-[5vw] lg:px-[8vw] relative z-30 text-color-primary flex justify-end items-center flex-col pb-[1vw] pt-[8vw]"
        >
            <div className="w-full h-[70vh] sm:h-[75vh] flex flex-col justify-center items-center relative">
                ...
                <h2 className="text-[11.2vw] md:text-[9vw] xl:text-[7vw] text-center leading-[100%] tracking-[-0.2vw] font-font1 text-color-primary hover:text-color-fourth transform-color easing cursor-pointer">
                    hello@gmail.com
                </h2>
                <div className="text-2xl leading-[100%] grid grid-cols-2 sm:grid-cols-4 flex-wrap gap-6 md:gap-6 lg:gap-8 mt-12 sm:mt-15 font-font1 px-8">
